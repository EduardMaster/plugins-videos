...
import net.eduard.api.central.reflection.Reflection;

abstract class CraftHologram implements Hologram {
	
	
	public static final JavaPlugin getPlugin(){
		return JavaPlugin.getProvidingPlugin(CraftHologram.class);
	}
