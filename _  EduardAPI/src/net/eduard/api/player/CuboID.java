...
public class CuboID
	...
	public World getWorld() {
		...
		if (world == null) {
			throw new IllegalStateException(
					"World '" + this.worldName + "' is not loaded");
		}
		return world;
	}
	...
	public CuboID expand(CuboidDirection dir, int amount) {
		switch (dir) {
			case Vertical :
				return new CuboID(this.worldName, this.x1 - amount, this.y1,
						this.z1, this.x2, this.y2, this.z2);
			case Down :
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2 + amount, this.y2, this.z2);
			case South :
				return new CuboID(this.worldName, this.x1, this.y1,
						this.z1 - amount, this.x2, this.y2, this.z2);
			case Unknown :
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2, this.y2, this.z2 + amount);
			case East :
				return new CuboID(this.worldName, this.x1, this.y1 - amount,
						this.z1, this.x2, this.y2, this.z2);
			case Both :
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2, this.y2 + amount, this.z2);
			case Horizontal :
			case North :
			case Up :
			default :
		...
		switch (dir) {
			case East :
				while ((face.containsOnly(0))
						&& (face.getLowerY() > getLowerY())) {
					face = face.shift(CuboidDirection.Down, 1);
				}
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2, face.getUpperY(), this.z2);
			case Both :
				while ((face.containsOnly(0))
						&& (face.getUpperY() < getUpperY())) {
					face = face.shift(CuboidDirection.Up, 1);
				}
				return new CuboID(this.worldName, this.x1, face.getLowerY(),
						this.z1, this.x2, this.y2, this.z2);
			case Vertical :
				while ((face.containsOnly(0))
						&& (face.getLowerX() > getLowerX())) {
					face = face.shift(CuboidDirection.North, 1);
				}
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						face.getUpperX(), this.y2, this.z2);
			case Down :
				while ((face.containsOnly(0))
						&& (face.getUpperX() < getUpperX())) {
					face = face.shift(CuboidDirection.South, 1);
				}
				return new CuboID(this.worldName, face.getLowerX(), this.y1,
						this.z1, this.x2, this.y2, this.z2);
			case South :
				while ((face.containsOnly(0))
						&& (face.getLowerZ() > getLowerZ())) {
					face = face.shift(CuboidDirection.East, 1);
				}
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2, this.y2, face.getUpperZ());
			case Unknown :
				while ((face.containsOnly(0))
						&& (face.getUpperZ() < getUpperZ())) {
	...
	public CuboID getFace(CuboidDirection dir) {
		switch (dir) {
			...
			case Both :
				return new CuboID(this.worldName, this.x1, this.y2, this.z1,
						this.x2, this.y2, this.z2);
			case Vertical :
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x1, this.y2, this.z2);
			case Down :
				return new CuboID(this.worldName, this.x2, this.y1, this.z1,
						this.x2, this.y2, this.z2);
			case South :
				return new CuboID(this.worldName, this.x1, this.y1, this.z1,
						this.x2, this.y2, this.z1);
			case Unknown :
				return new CuboID(this.worldName, this.x1, this.y1, this.z2,
						this.x2, this.y2, this.z2);
			case Horizontal :
			case North :
			case Up :
	...
	public Iterator<Block> iterator() {
		return new CuboidIterator(getWorld(), this.x1, this.y1, this.z1,
				this.x2, this.y2, this.z2);
	}
	...
	public String toString() {
		return new String("Cuboid: " + this.worldName + "," + this.x1 + ","
				+ this.y1 + "," + this.z1 + "=>" + this.x2 + "," + this.y2 + ","
				+ this.z2);
	}
