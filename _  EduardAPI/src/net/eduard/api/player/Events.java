...
public class Events extends EventAPI implements Save, Cloneable, PlayerEffect {
	...
	public void clearItems(LivingEntity livingEntity) {
		if (clearItems) {
			API.clearItens(livingEntity);
		}
	}
	public void clearArmours(LivingEntity livingEntity) {
		if (clearArmours) {
			API.clearArmours(livingEntity);
		}
	...
	public Events setSound(SoundEffect sound) {
		this.sound = sound;
		return this;
	}
