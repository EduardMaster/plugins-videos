...
import static net.eduard.simplespunir.TextualComponent.rawText;
...
//		map.put("JSON", toJSONString());
	 ...
	 * This is called by the Bukkit serialization Mine.
	 * It is not intended for direct public Mine consumption.
	 *
	...
	/**
	 * <b>Internally called method. Not for Mine consumption.</b>
	 */
	@Override
		...
		for (JsonElement mPrt : extra) {
			...
			for (Map.Entry<String, JsonElement> entry : messagePart.entrySet()) {
				...
				if (TextualComponent.isTextKey(entry.getKey())) {
					...
					Map<String, Object> serializedMapForm = new HashMap<String, Object>(); // Must be object due to Bukkit serializer Mine compliance
