...
public class Blocks implements Cloneable {
	...
	public Blocks(Location firstPosition, Location secondPosition) {
	...
	public Blocks copy(boolean copyAir) {
		blocks.clear();
		setupHighLow();
	...
	public Blocks move(Location playerPosition) {
	...
	public Blocks paste(boolean applyPhisics) {
		for (BlockState block : blocks) {
			block.update(true, applyPhisics);
		}
		return this;
	}
	public Blocks paste(Location playerPosition) {
	...
	@SuppressWarnings("deprecation")
	public Blocks reload(File file) {
		try {
	...
	public static Blocks load(File file) {
		return new Blocks().reload(file);
	}
