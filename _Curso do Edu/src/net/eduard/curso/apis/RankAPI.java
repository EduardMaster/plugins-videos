package net.eduard.curso.apis;

import net.eduard.api.lib.BukkitConfig;
import net.eduard.api.lib.storage.StorageAPI;
import net.eduard.curso.CursoMain;
import net.eduard.curso.manager.Rank;
import net.eduard.curso.manager.RankManager;

public class RankAPI {

	private static BukkitConfig config = new BukkitConfig("rankup.yml", CursoMain.getInstance());
